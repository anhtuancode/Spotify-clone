...
export default function DetailAlbumLayout() {
  const { id } = useParams();
  const album = Albums.find((a) => a.idAlbum === Number(id));
  console.log(Albums);
      ...
      <div>
        <div className="flex gap-6 items-center mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-2">{album.artist}</p>
          ...
          <tbody>
            {Albums.map((album, idx) => (
              ...
              >
                ...
                <td className="py-2 px-2">{album.artist}</td>
                <td className="py-2 px-2 text-sm text-gray-400">{album.title}</td>
                <td className="py-2 px-2">{album.description}</td>
              </tr>
            ))}
          </tbody>
        </table>
